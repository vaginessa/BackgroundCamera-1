            ...
            switch (flag) {
                case NewMessageNotification.IMAGE_CAPTURED:
                    builder.setContentIntent(PendingIntent.getActivity(context, 0,
                            new Intent(context, GalleryGrid.class).putExtra(Constant.FROM_NOTIFICATION, true).setFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT), PendingIntent.FLAG_CANCEL_CURRENT));
                ...
                case NewMessageNotification.PERMISSION_DENIED:
                    builder.setContentIntent(PendingIntent.getActivity(context, 0,
                            new Intent(context, AgreementActivity.class).setFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT), PendingIntent.FLAG_CANCEL_CURRENT));
                    builder.setOngoing(false);
                    break;
